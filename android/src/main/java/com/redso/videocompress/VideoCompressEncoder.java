...
import com.redso.videocompress.muxer.CodecInputSurface;
 ...
 */
public class VideoCompressEncoder {

    private static final String TAG = "VideoCompressEncoder";
     ...
     *
     * */
    public boolean convertVideo(final String sourcePath, String destinationPath, int nwidth, int nheight, int nbitrate, VideoCompressProgressListener listener) {
